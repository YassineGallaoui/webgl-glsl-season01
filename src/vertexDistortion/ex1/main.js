...
const loadPageSCript = () => {
    ...
    shaders.vertexShader = `
        ...
        void main(){
            ...
            float distortionX=sin(clipSpace.x*frequency-u_time)*amplitude;
            float distortionY=sin(clipSpace.y*frequency-u_time)*amplitude;
            clipSpace.x+=distortionX;
            clipSpace.y+=distortionY;
